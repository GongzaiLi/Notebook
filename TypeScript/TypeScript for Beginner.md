...
**换句话来说 类型拓宽：当一个variable没有指定初始的type， 它自动给从初value 中推断并指定variable的type.**
...
- 未及时清理 `state.errorMsg` 的值，因此如果之前的请求失败，那么你将继续看到错误消息，而不是加载消息。在开始的时候没有清理。
...
1. https://mp.weixin.qq.com/s/kNTjrBa5w2DbJOM8mHdETg